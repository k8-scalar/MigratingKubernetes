...
This project containts supplementary material for the paper, "Eddy Truyen, Nane Kratzke, Dimitri Van Landuyt, Bert Lagaisse, Wouter Joosen, A case study on feature incompatibilities between Kubernetes vendors of the hosted product type" ([pdf](paper.pdf)).
